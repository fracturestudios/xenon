...
/** A button whose isDown() value is true if and only if all of its child
  * XeButtonInputs are also down. Acts like an AND gate for
  * XeButtonInput::isDown().
  */
class XE_EXPORT XeAndButton : XeButtonInput
{
public:
